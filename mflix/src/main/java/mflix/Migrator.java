...
public class Migrator {
	...
	/**
	 * Creates and UpdateOneModel object for each Document that contains an "imdb.rating" field of non-numerical type into a
	 * parsable
	 *
	 * @param doc
	 *            - Document object to be updated
	...
	/**
	 * Creates an UpdateOneModel for each Document object field `lastupdated` of type string into an update $set to Date
	 * type. db.movies.update({_id: doc._id}, {$set: {lastupdated: ISODate(doc.lastupdated)}})
	 *
	 * @param doc
	 *            - Document object to get the date transformation applied to
	 ...
	 *
	 * @param args
	 *             is a set of system arguments that can be ignored.
	 */
	public static void main(String[] args) {
		...
		String mongoUri = "mongodb+srv://m220student:m220password@mflix-wbuv2.mongodb.net/test?retryWrites=true";
